...
#
# PCM0 ---> volume ----> ALH 2 BE dailink 1
# PCM1 <--- volume <---- ALH 3 BE dailink 1
# PCM2 ---> volume ----> ALH 2 BE dailink 2
# PCM3 ---> volume ----> ALH 4 BE dailink 1
...
# Low Latency capture pipeline 4 on PCM 3 using max 2 channels of s32le.
# Schedule 48 frames per 1000us deadline on core 0 with priority 0
PIPELINE_PCM_ADD(sof/pipe-volume-capture.m4,
	4, 3, 2, s32le,
	1000, 0, 0,
...
DAI_ADD(sof/pipe-dai-playback.m4,
	1, ALH, 0x102, SDW1-Playback-rt711-aif1,
	PIPELINE_SOURCE_1, 2, s24le,
	1000, 0, 0, SCHEDULE_TIME_DOMAIN_TIMER)

# capture DAI is ALH(SDW1 PIN2) using 2 periods
# Buffers use s24le format, with 48 frame per 1000us on core 0 with priority 0
DAI_ADD(sof/pipe-dai-capture.m4,
	2, ALH, 0x103, SDW1-Capture-rt711-aif1,
...
# capture DAI is ALH(SDW1 PIN4) using 2 periods
# Buffers use s24le format, with 48 frame per 1000us on core 0 with priority 0
DAI_ADD(sof/pipe-dai-capture.m4,
	4, ALH, 0x104, SDW1-Capture-rt711-aif2,
...
#ALH SDW0 Pin2 (ID: 0)
DAI_CONFIG(ALH, 0x102, 0, SDW1-Playback-rt711-aif1,
	ALH_CONFIG(ALH_CONFIG_DATA(ALH, 0x102, 48000, 2)))

#ALH SDW0 Pin3 (ID: 1)
DAI_CONFIG(ALH, 0x103, 1, SDW1-Capture-rt711-aif1,
...
#ALH SDW0 Pin3 (ID: 3)
DAI_CONFIG(ALH, 0x104, 3, SDW1-Capture-rt711-aif2,
	ALH_CONFIG(ALH_CONFIG_DATA(ALH, 0x104, 48000, 2)))
