...
DAI_ADD(sof/pipe-dai-playback.m4,
	1, ALH, 0x2, SDW0-Playback,
	PIPELINE_SOURCE_1, 2, s24le,
	1000, 0, 0, SCHEDULE_TIME_DOMAIN_TIMER)

# capture DAI is ALH(SDW0 PIN3) using 2 periods
# Buffers use s24le format, with 48 frame per 1000us on core 0 with priority 0
DAI_ADD(sof/pipe-dai-capture.m4,
	2, ALH, 0x3, SDW0-Capture,
...
PCM_CAPTURE_ADD(Feedback, 1, PIPELINE_PCM_2)
...
#ALH SDW0 Pin2 (ID: 2)
DAI_CONFIG(ALH, 0x2, 2, SDW0-Playback,
	ALH_CONFIG(ALH_CONFIG_DATA(ALH, 0x2, 48000, 2)))

#ALH SDW0 Pin3 (ID: 3)
DAI_CONFIG(ALH, 0x3, 3, SDW0-Capture,
	ALH_CONFIG(ALH_CONFIG_DATA(ALH, 0x3, 48000, 2)))
